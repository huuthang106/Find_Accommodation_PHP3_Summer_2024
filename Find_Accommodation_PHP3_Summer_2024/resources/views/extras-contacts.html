                        ...
                        <div class="row">
                                ...
                                <div class="text-center card-box ribbon-box">
                                    <div class="member-card">
                                        ...
                                        <div class="avatar-xl member-thumb mx-auto">
                                            <img src="..\..\public\assets\images\users\avatar-1.jpg" class="rounded-circle img-thumbnail" alt="profile-image">
                            ...
                            <div class="col-lg-4">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        <div class="avatar-xl member-thumb mx-auto">
                                            <img src="..\..\public\assets\images\users\avatar-2.jpg" class="rounded-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        <div class="avatar-xl member-thumb mx-auto">
                                            <img src="..\..\public\assets\images\users\avatar-3.jpg" class="rounded-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        <div class="avatar-xl member-thumb mx-auto">
                                            <img src="..\..\public\assets\images\users\avatar-4.jpg" class="rounded-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="text-center card-box ribbon-box">
                                    <div class="member-card">
                                        ...
                                        <div class="avatar-xl member-thumb mx-auto">
                                            <img src="..\..\public\assets\images\users\avatar-5.jpg" class="rounded-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        <div class="avatar-xl member-thumb mx-auto">
                                            <img src="..\..\public\assets\images\users\avatar-6.jpg" class="rounded-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                        </div>
