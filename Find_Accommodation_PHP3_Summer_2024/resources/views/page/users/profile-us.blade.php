                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <form action="{{ route('chinh-sua-thong-tin', ['id' => $user->id]) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="password" class="form-control" id="Password"
                                                                name="passsword" placeholder="6 - 15 Ký tự">
                                                        </div>
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item me-3">
                                                                <a title="Facebook" data-bs-toggle="tooltip"
                                                                    href="#">
                                                                    <i class="fab fa-facebook-f"></i>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item me-3">
                                                                <a title="Twitter" data-bs-toggle="tooltip"
                                                                    href="#">
                                                                    <i class="fab fa-twitter"></i>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <a title="Skype" data-bs-toggle="tooltip"
                                                                    href="#">
                                                            ...
                                                            <tbody>
                                                                @foreach ($rooms as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td><button class="btn btn-primary">Xem chi
                                                                                tiết</button></td>
                                                                        <td><button class="btn btn-primary">Chỉnh
                                                                                sửa</button></td>
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('delete-posting', $item->id) }}"
                                                                                method="GET">
                                                                                @csrf
                                                                                <button type="submit"
