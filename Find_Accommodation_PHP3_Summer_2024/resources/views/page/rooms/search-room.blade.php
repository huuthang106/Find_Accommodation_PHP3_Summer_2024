<!-- resources/views/page/search.blade.php -->
        ...
        <div class="row">
            <div class="col-lg-9 p-0 rounded-5">
                <div class="p-3 mb-2 bg-light text-dark">
                    ...
                    <table id="myTable" class="" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <div class="card mb-3 bg-light text-dark">
                                                <a href="{{ route('get-room', ['id' => $room->id]) }}" class="text-decoration-none">
                                                    <div class="div">
                                                        <div class="row g-0">
                                                            <div class="col-md-4">
                                                                <img src="https://tromoi.com/uploads/members/hiephoang/thang%208/17_08/nhung-dieu-bat-buoc-phai-nho-khi-tim-phong-01.jpg" class="img-fluid rounded-2" alt="">
                                                            </div>
                                                            <div class="col-md-8">
                                                                <div class="card-body">
