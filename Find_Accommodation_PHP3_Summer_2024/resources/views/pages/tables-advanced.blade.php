@extends('layouts.app')
@section('title', 'Tables Advanced | Simple - Responsive Bootstrap 4 Admin Dashboard')
@section('content')
    <div class="content">
                ...
                <div class="col-12">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="sub-header">
                            ...
                            be assigned to individual cells, columns, rows or all cells.
                        </p>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="sub-header">
                            ...
                            without effecting other rows, unlike the os and single options shown in other examples.
                        </p>
